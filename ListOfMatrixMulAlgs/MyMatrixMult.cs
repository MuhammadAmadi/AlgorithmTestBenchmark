namespace ListOfMatrixMulAlgs
{
    public class MyMatrixMult
    {
        const int THREADS_NUMBER = 8;
        const int N = 1000;

        public static void MatrixMultiplication(int[,] a, int[,] b, int[,] r)
        {
